...
class _SubscriptionsPageState extends State<SubscriptionsPage> with TickerProviderStateMixin {
  ...
  Future<void> _handleSuccessfulPurchase(PurchaseDetails purchaseDetails) async {
    ...
    DateTime expiry;
    if (purchaseDetails.productID == 'XixiWeekVIP') {
      expiry = now.add(const Duration(days: 7));
    } else if (purchaseDetails.productID == 'XixiMonthVIP') {
  ...
  Widget build(BuildContext context) {
    ...
    final List<List<_Privilege>> planPrivileges = [
      // Weekly
      [
        _Privilege(icon: Icons.accessibility_new, text: 'Unlimited access to dance post content'),
      ...
      [
        ...
        _Privilege(icon: Icons.block, text: 'Ad-free experience'),
        _Privilege(icon: Icons.star, text: 'Unlimited modification of user avatars'),
        _Privilege(icon: Icons.favorite, text: 'Unlimited participation in event registration'),
      ],
    ];
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            TextButton(
                              onPressed: () => _launchURL('https://www.privacypolicies.com/live/77ad19af-b30a-4b56-899c-ec40d8f90049'),
                              child: Text(
                                'Privacy Policy',
                                style: TextStyle(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                '3. Tap Subscriptions\n'
                                '4. Find Dance Premium in the list\n'
