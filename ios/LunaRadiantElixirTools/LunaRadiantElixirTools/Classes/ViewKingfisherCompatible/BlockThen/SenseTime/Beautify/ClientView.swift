...
/*: "st_slider_thumb" :*/
fileprivate let k_withData:[Character] = ["s","t","_","s","l","i","d","e","r","_","t","h","u","m","b"]

/*: "init(coder:) has not been implemented" :*/
fileprivate let k_suiteUrl:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class ClientView: UISlider {
    ...
    override var currentThumbImage: UIImage? {
        ...
        get {
            ...
            return UIImage.barName(name: (String(k_withData)))
        }
        //: set {
        set {}
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_suiteUrl.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var valueView: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.colorTitle(type: .Regular, fontSize: 12)
