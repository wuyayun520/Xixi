...
//: @objcMembers public class FilterEntiretycostModel: JSONModel {
@objcMembers public class FilterEntiretycostModel: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = ScreenEquatable.Face
...
//: @objc extension FilterEntiretycostModel {
@objc extension FilterEntiretycostModel {
    //: func initWith(suiteType: BeautyItemType)-> FilterEntiretycostModel {
    func roomsTable(suiteType: ScreenEquatable) -> FilterEntiretycostModel {
        //: let model = FilterEntiretycostModel.init()
        let model = FilterEntiretycostModel()
