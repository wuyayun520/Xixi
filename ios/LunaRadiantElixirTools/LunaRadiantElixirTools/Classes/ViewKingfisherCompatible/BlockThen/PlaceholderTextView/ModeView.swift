...
/*: / :*/
fileprivate let appBlockFromPhotoMsg:[Character] = ["/"]

/*: "\n" :*/
fileprivate let constScaleText:String = "\n"
...
class ModeView: UIView {
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        cellTool(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        cellTool(placeholder: nil, placeholderColor: nil)
    }
}
...
extension ModeView {
    ...
    private func cellTool(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(ViewLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(ViewLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-ViewLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: StarringContainerInset().top, left: StarringContainerInset().left, bottom: StarringContainerInset().bottom, right: StarringContainerInset().right)
...
extension ModeView: UITextViewDelegate {
