...
fileprivate let data_titleTailMsg:[UInt8] = [0xbf,0xb8,0xbf,0xa2,0xfe,0xb5,0xb9,0xb2,0xb3,0xa4,0xec,0xff,0xf6,0xbe,0xb7,0xa5,0xf6,0xb8,0xb9,0xa2,0xf6,0xb4,0xb3,0xb3,0xb8,0xf6,0xbf,0xbb,0xa6,0xba,0xb3,0xbb,0xb3,0xb8,0xa2,0xb3,0xb2]

/*: "Cancel" :*/
fileprivate let notiDataId:[Character] = ["C","a","n","c","e","l"]

/*: "Sure" :*/
fileprivate let const_externalValue:[Character] = ["S","u","r","e"]
...
class BlockHandPickThen: UIView {
    // 背景视图
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: data_titleTailMsg.map{$0^214}, encoding: .utf8)!)
    }

    //: private func setupView() {
    private func sinceGift() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(runningPushAside))
        ...
        cancelButton.setTitle((String(notiDataId)).localized, for: .normal)
        //: cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: cancelButton.setTitleColor(UIColor.black, for: .normal)
        cancelButton.setTitleColor(UIColor.black, for: .normal)
        //: cancelButton.addTarget(self, action: #selector(cancelClick(button:)), for: .touchUpInside)
        cancelButton.addTarget(self, action: #selector(changeNext(button:)), for: .touchUpInside)
        ...
        confirmButton.setTitle((String(const_externalValue)).localized, for: .normal)
        //: confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: confirmButton.setTitleColor(UIColor.black, for: .normal)
        confirmButton.setTitleColor(UIColor.black, for: .normal)
        //: confirmButton.addTarget(self, action: #selector(confirmClick(button:)), for: .touchUpInside)
        confirmButton.addTarget(self, action: #selector(valueMove(button:)), for: .touchUpInside)
    ...
    @objc func changeNext(button _: UIButton) {
        //: dismissView()
        runningPushAside()
    }

    //: @objc func confirmClick(button: UIButton) {
    @objc func valueMove(button _: UIButton) {
        //: dismissView()
        runningPushAside()
    }
