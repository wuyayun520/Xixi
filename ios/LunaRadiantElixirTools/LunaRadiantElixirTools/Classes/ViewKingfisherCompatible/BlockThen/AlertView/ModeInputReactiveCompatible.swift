...
fileprivate let notiEditValue:String = "btn_mefinish player shared view"
fileprivate let main_interestName:String = "cofilein"
fileprivate let mainImageStr:[Character] = ["u","e"]

/*: "init(coder:) has not been implemented" :*/
fileprivate let notiIconTitle:[UInt8] = [0xf7,0xf0,0xf7,0xea,0xb6,0xfd,0xf1,0xfa,0xfb,0xec,0xa4,0xb7,0xbe,0xf6,0xff,0xed,0xbe,0xf0,0xf1,0xea,0xbe,0xfc,0xfb,0xfb,0xf0,0xbe,0xf7,0xf3,0xee,0xf2,0xfb,0xf3,0xfb,0xf0,0xea,0xfb,0xfa]
...
// __CLOSE_PRINT__
//
//  ModeInputReactiveCompatible.swift
//  AbroadTalking
//
...
class ModeInputReactiveCompatible: UIView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(walkingClick), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(timeGift), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: DigitizerAlertConfig)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (String(notiEditValue.prefix(6)) + "_back_" + main_interestName.replacingOccurrences(of: "file", with: "nt") + String(mainImageStr))
        }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiIconTitle.map{$0^158}, encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func limitQuote(title: String, isTouch: Bool) {
