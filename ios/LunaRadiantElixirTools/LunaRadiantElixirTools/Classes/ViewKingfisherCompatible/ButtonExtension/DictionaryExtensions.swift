...
extension Dictionary {
    ...
    public static func chalkLineSocial(withJsonString jsonString: String?) -> [String: Any]? {
...
extension NSDictionary {
    ...
    @objc public class func tillName(withJsonString jsonString: String?) -> NSDictionary? {
        //: guard let result = Dictionary<String, Any>.dictionary(withJsonString: jsonString) else {
        guard let result = Dictionary<String, Any>.chalkLineSocial(withJsonString: jsonString) else {
            //: return nil
            return nil
        }
