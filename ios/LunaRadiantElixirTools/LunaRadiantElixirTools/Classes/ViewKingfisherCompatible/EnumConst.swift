...
/// 性别
//: enum Gender: String {
enum FalloutCompatibleValue: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum NameContiguousBytes: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum MotionVideoHashableRepresentation: Int {
    //: case unknown    = 0
    case unknown = 0
    //: case social     = 1
    case social = 1 // 社交礼物
...
@objc enum ScanPropertyProtocol: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum FootingPropertyProtocol: Int {
    //: case Unavailable = 0
