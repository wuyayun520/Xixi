...
/*: "App" :*/
fileprivate let kTaskKey:[Character] = ["A","p","p"]

/*: "blockList_ :*/
fileprivate let user_incomeStateMsg:[Character] = ["b","l","o","c","k","L","i"]
fileprivate let k_equalFormat:String = "st_last else let string"
...
class ManageressThen: NSObject {
    ...
    static let shared = ManageressThen()
    ...
    override private init() {
        ...
        super.init()
        //: loadBlockList()
        sickListMetalBarLadeEqual()
    }

    /// 加载拉黑列表
    //: func loadBlockList() {
    func sickListMetalBarLadeEqual() {
    ...
    func renderWillId(userId: String) {
    ...
    func acceptForCell(userId: String) {
    ...
    func anyUser(userId: String) -> Bool {
    ...
    private func permit() -> String {
        //: let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        //: let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent("App")
        let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent((String(kTaskKey)))
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((String(user_incomeStateMsg) + String(k_equalFormat.prefix(3))) + "\(uid)")
        //: return filePath
        return filePath
    }
}
