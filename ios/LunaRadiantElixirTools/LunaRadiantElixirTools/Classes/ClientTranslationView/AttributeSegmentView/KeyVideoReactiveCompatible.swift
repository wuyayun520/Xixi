...
fileprivate let app_cellPath:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_coinxxx" :*/
fileprivate let mainIndexText:String = "share view usericon_c"

/*: "icon_gift_num_bg" :*/
fileprivate let showModelName:[Character] = ["i","c","o","n","_","g","i","f","t","_","n","u","m","_","b","g"]

/*: "x1" :*/
fileprivate let appNameId:[Character] = ["x","1"]

/*: " x :*/
fileprivate let notiTopValue:[Character] = [" ","x"]
...
// __CLOSE_PRINT__
//
//  KeyVideoReactiveCompatible.swift
//  AbroadTalking
//
...
class KeyVideoReactiveCompatible: UICollectionViewCell {
    //: var model = TalkingRoomGiftModel()
    var model = GroupModelType()
    //: let checked = false
    let checked = false
    //: let giftNum = 0
    let giftNum = 0
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_cellPath.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var nameLB: UILabel = {
        ...
        lb.font = UIFont.colorTitle(type: .Regular, fontSize: 10)
        //: lb.textColor = .white
        lb.textColor = .white
    ...
    lazy var priceBtn: TalkingItemButton = {
        //: let btn = TalkingButton.init()
        let btn = TalkingItemButton()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Regular, fontSize: 10)
        btn.titleLabel?.font = UIFont.colorTitle(type: .Regular, fontSize: 10)
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_coinxxx"), for: .normal)
        btn.setImage(UIImage.barName(name: (String(mainIndexText.suffix(6)) + "oinxxx")), for: .normal)
    ...
    lazy var numBgView: UIImageView = {
        ...
        let imag = UIImage.barName(name: (String(showModelName)))
        //: let sizex = imag.size
        let sizex = imag.size
    ...
    lazy var numLb: UILabel = {
        ...
        lb.font = UIFont.colorTitle(type: .Regular, fontSize: 9)
        //: return lb
        return lb
        //: }()
    }()
...
extension KeyVideoReactiveCompatible {
    /// 更改选中状态
    //: func setChecked(checked: Bool) {
    func sendChecked(checked: Bool) {
        ...
        if checked {
            ...
            bgView.layer.borderColor = UIColor.readModeAchromaticColour().cgColor
    ...
    func second(currenmodel: GroupModelType, giftType: ReloadDefaultsSerializable) {
        //: model = currenmodel
        model = currenmodel
        //: giftIcon.setUrlImage(urlStr: model.imgPreview ?? "")
        giftIcon.sinceMoment(urlStr: model.imgPreview ?? "")
        //: priceBtn.setTitle("\(model.price)", for: .normal)
        priceBtn.setTitle("\(model.price)", for: .normal)
        //: selectedImageView.setUrlImage(urlStr: model.cornerMark, placeImg: nil)
        selectedImageView.sinceMoment(urlStr: model.cornerMark, placeImg: nil)
        ...
        let attributes = [NSAttributedString.Key.font: UIFont.colorTitle(type: .Regular, fontSize: 11),
...
extension KeyVideoReactiveCompatible {
    ...
    func detailBy() {
        ...
        bgView.backgroundColor = UIColor.achromaticColourPath()
