...
open class EffectScrollView: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = EffectScrollView.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
