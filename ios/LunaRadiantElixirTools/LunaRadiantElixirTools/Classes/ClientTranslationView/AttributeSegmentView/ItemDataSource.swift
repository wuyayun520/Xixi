...
fileprivate let show_sectionKitFormat:[UInt8] = [0xc7,0xc0,0xc7,0xda,0x86,0xcd,0xc1,0xca,0xcb,0xdc,0x94,0x87,0x8e,0xc6,0xcf,0xdd,0x8e,0xc0,0xc1,0xda,0x8e,0xcc,0xcb,0xcb,0xc0,0x8e,0xc7,0xc3,0xde,0xc2,0xcb,0xc3,0xcb,0xc0,0xda,0xcb,0xca]

/*: "#292929" :*/
fileprivate let data_clickValue:String = "#292929"

/*: "9999999" :*/
fileprivate let kDataMessage:String = "income"
fileprivate let mainCellCenterMessage:[Character] = ["9","9","9","9","9","9"]

/*: "icon_coin" :*/
fileprivate let user_addPathTitle:String = "icstatus"
fileprivate let constSoundText:[Character] = ["n","_","c","o","i","n"]

/*: "icon_gift_more_arrow" :*/
fileprivate let main_toStackMessage:String = "ishown"
fileprivate let showMessageName:String = "t_more_small make model version"
fileprivate let showRandomMsg:String = "arrshare"

/*: "Hot" :*/
fileprivate let data_barPath:String = "Hotvar let image"

/*: "VIP" :*/
fileprivate let notiFillFormat:String = "VIhello"

/*: "Bags" :*/
fileprivate let noti_bagStr:String = "succeed click app photo inBags"

/*: "icon_gift_num_arrow" :*/
fileprivate let appReplyTitleData:String = "iclayer"
fileprivate let main_toBucketIfMessage:[Character] = ["u","m","_","a","r","r","o","w"]

/*: "Send" :*/
fileprivate let appEraseText:[Character] = ["S","e","n","d"]

/*: "nav_back_black_nor" :*/
fileprivate let show_modelKey:String = "nav_party view"
fileprivate let show_targetGiftId:[Character] = ["_","b","l","a","c","k","_","n","o","r"]

/*: "The number of gifts cannot be less than 1" :*/
fileprivate let constBarData:[UInt8] = [0x31,0x20,0x6e,0x61,0x68,0x74,0x20,0x73,0x73,0x65,0x6c,0x20,0x65,0x62,0x20,0x74,0x6f,0x6e,0x6e,0x61,0x63,0x20,0x73,0x74,0x66,0x69,0x67,0x20,0x66,0x6f,0x20,0x72,0x65,0x62,0x6d,0x75,0x6e,0x20,0x65,0x68,0x54]

/*: "Please select a gift" :*/
fileprivate let k_equalStr:String = "Pleasmatch corner make"
fileprivate let app_selectedValue:String = "filter"
fileprivate let mainLightMessage:[Character] = [" ","s","e","l","e","c","t"," ","a"," ","g","i","f","t"]

/*: "Please select an object" :*/
fileprivate let appGiftToName:String = "var downPlease"
fileprivate let dataSizeUrl:String = "t an to height user let extension"

/*: "Select the desired gift to unlock" :*/
fileprivate let userPageKey:[UInt8] = [0xbd,0xcf,0xd6,0xcf,0xcd,0xde,0x8a,0xde,0xd2,0xcf,0x8a,0xce,0xcf,0xdd,0xd3,0xdc,0xcf,0xce,0x8a,0xd1,0xd3,0xd0,0xde,0x8a,0xde,0xd9,0x8a,0xdf,0xd8,0xd6,0xd9,0xcd,0xd5]

fileprivate func pathJust(content num: UInt8) -> UInt8 {
...
/*: "OK" :*/
fileprivate let const_hiddenStr:[Character] = ["O","K"]

/*: "Select object >" :*/
fileprivate let showAlongPath:[Character] = ["S","e","l","e","c","t"," ","o","b","j","e","c","t"," ",">"]

/*: "It looks like there's nothing" :*/
fileprivate let k_rowValue:[Character] = ["I","t"," ","l","o","o","k","s"," ","l","i","k","e"," ","t","h","e","r","e","\'","s"," ","n","o","t","h","i"]
fileprivate let app_makePath:String = "labg"

/*: "FF75A4" :*/
fileprivate let user_objectId:String = "pointpoint75A4"

/*: "E570FF" :*/
fileprivate let noti_normalSampleName:[Character] = ["E","5","7","0","F","F"]

/*: "Ask for" :*/
fileprivate let mainDataStr:[Character] = ["A","s","k"," ","f","o","r"]

/*: " Select %@ > " :*/
fileprivate let data_colorFormat:[Character] = [" ","S","e","l","e","c","t"," ","%","@"," ",">"," "]

/*: "All Numbers" :*/
fileprivate let app_allValue:String = "text sizeAll "

/*: "View detailed description >" :*/
fileprivate let appLabData:String = "View to mouth if"
fileprivate let show_attentionId:[Character] = ["d","e","t","a","i","l","e","d"," ","d","e","s","c","r","i","p","t","i","o","n"," ",">"]

/*: "\n" :*/
fileprivate let userEqualPath:String = "\n"

/*: "%.2f" :*/
fileprivate let constShareFormat:[Character] = ["%",".","2","f"]

/*: "9999" :*/
fileprivate let appOverFormat:[Character] = ["9","9","9","9"]

/*: "Custom" :*/
fileprivate let app_wrapMsg:[Character] = ["C","u","s","t","o","m"]

/*: "mf_coin" :*/
fileprivate let user_countPath:String = "msize"
fileprivate let kMarginTableKey:String = "cell request_coin"

/*: "showBagsRed" :*/
fileprivate let mainBlindPath:[Character] = ["s","h","o","w","B","a","g","s","R","e"]
fileprivate let main_pairTitle:[Character] = ["d"]
...
enum ReloadDefaultsSerializable: Int {
    //: case Hot = 0
    case Hot = 0 // 默认礼物
    //: case Vip = 1
    case Vip = 1 // vip礼物
...
typealias SendFunctionBlock = (_ giftModel: GroupModelType, _ num: String) -> Void
// 索要礼物Block
//: typealias AskforFunctionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String) -> Void
typealias AskforFunctionBlock = (_ giftModel: GroupModelType, _ num: String) -> Void
// 私密照片发送礼物Block
//: typealias OKButtonBlock = (_ giftModel: TalkingRoomGiftModel) -> Void
typealias OKButtonBlock = (_ giftModel: GroupModelType) -> Void
// 群聊发送礼物Block
//: typealias ChatRoomSendActionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String, _ model: TalkingChatRoomMemberModel) -> Void
typealias ChatRoomSendActionBlock = (_ giftModel: GroupModelType, _ num: String, _ model: SaveMeasurable) -> Void
// 隐藏礼物面板Block
...
private let appScreenUrl = 44.0
//: let GiftScrollContentView_H = 252.0
let show_tableValue = 252.0
//: private let pageControl_H = 7.0
private let data_changeDeviceFormat = 7.0
//: private let bottomView_H = 44.0
private let noti_showKeyBarName = 44.0

//: class TalkingChatGiftView: UIView {
class ItemDataSource: UIView {
    //: var chatRoomID = ""
    var chatRoomID = ""
    ...
    var contentHeight = appScreenUrl + show_tableValue + data_changeDeviceFormat + noti_showKeyBarName + constBarStr
    //: var keyborHeight = 0
    var keyborHeight = 0
    ...
    private var titlesArr = [ReloadDefaultsSerializable]()
    // 当前选中数据类型
    //: private var currType = GiftDataType.Hot
    private var currType = ReloadDefaultsSerializable.Hot
    ...
    init(frame: CGRect = .zero, style: DateSendable = .normal, titlesArr: [ReloadDefaultsSerializable] = [.Hot, .Vip, .Bags]) {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_sectionKitFormat.map{$0^174}, encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIView = {
        ...
        let frame = CGRect(x: 0, y: kStatusName, width: appUseMessage, height: contentHeight)
        //: let content = UIView(frame: frame)
        let content = UIView(frame: frame)
        //: content.backgroundColor = .init(hex: "#292929")
        content.backgroundColor = .init(hex: (data_clickValue.capitalized))
        //: content.Corner(width: ScreenWidth, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        content.occurrenceOf(width: appUseMessage, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
    ...
    lazy var partyIconView: VoiceViewDelegate = {
        //: let frame = CGRect(x: 0, y: 0, width: ScreenWidth, height: TalkingVoiceRoomIconGiftView_H)
        let frame = CGRect(x: 0, y: 0, width: appUseMessage, height: data_messageStr)
        //: let view = TalkingVoiceRoomIconGiftView(frame: frame)
        let view = VoiceViewDelegate(frame: frame)
        //: view.isHidden = true
        view.isHidden = true
    ...
    private lazy var topView: UIView = {
        ...
        let frame = CGRect(x: 0, y: 0, width: appUseMessage, height: appScreenUrl)
        //: let view = UIView(frame: frame)
        let view = UIView(frame: frame)
        //: view.backgroundColor = .init(hex: "#292929")
        view.backgroundColor = .init(hex: (data_clickValue.capitalized))
        //: contentView.addSubview(view)
        contentView.addSubview(view)
        //: return view
        return view
    ...
    private lazy var moneyBtn: TalkingItemButton = {
        //: let btn = TalkingButton()
        let btn = TalkingItemButton()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Medium, fontSize: 14)
        btn.titleLabel?.font = UIFont.colorTitle(type: .Medium, fontSize: 14)
        //: btn.setTitle("9999999", for: .normal)
        btn.setTitle((kDataMessage.replacingOccurrences(of: "income", with: "9") + String(mainCellCenterMessage)), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_coin"), for: .normal)
        btn.setImage(UIImage.barName(name: (user_addPathTitle.replacingOccurrences(of: "status", with: "o") + String(constSoundText))), for: .normal)
    ...
    private lazy var rechargeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(viewTool), for: .touchUpInside)
    ...
    private lazy var indicatorImage: UIImageView = {
        ...
        img.image = UIImage.barName(name: (main_toStackMessage.replacingOccurrences(of: "show", with: "co") + "_gif" + String(showMessageName.prefix(7)) + showRandomMsg.replacingOccurrences(of: "share", with: "ow")))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var pageControl: UIPageControl = {
        ...
        page.currentPageIndicatorTintColor = UIColor.buttonThemeTip(180, 180, 180, 1)
        //: page.pageIndicatorTintColor = UIColor.RGBA(60, 60, 60, 1)
        page.pageIndicatorTintColor = UIColor.buttonThemeTip(60, 60, 60, 1)
    ...
    private lazy var hotGiftCollectionView: UICollectionView = {
        ...
        let layout = PresentationGiftLayout()
        ...
        hot.register(KeyVideoReactiveCompatible.self, forCellWithReuseIdentifier: KeyVideoReactiveCompatible.className())
        //: return hot
        return hot
        //: }()
    }()
    ...
    private lazy var hotGiftLayout: PresentationGiftLayout = //: return hotGiftCollectionView.collectionViewLayout as! PresentationGiftLayout
        hotGiftCollectionView.collectionViewLayout as! PresentationGiftLayout
    //: }()
    ...
    private lazy var titleScrollView: AttributeSegmentView = {
        //: var titles = [String]()
        var titles = [String]()
        ...
        titlesArr.forEach { type in
            ...
            case .Hot:
                ...
                titles.append((String(data_barPath.prefix(3))).localized)
            //: case .Vip:
            case .Vip:
                //: titles.append("VIP".localized)
                titles.append((notiFillFormat.replacingOccurrences(of: "hello", with: "P")).localized)
            //: case .Bags:
            case .Bags:
                //: titles.append("Bags".localized)
                titles.append((String(noti_bagStr.suffix(4))).localized)
            }
        }
        //: var style = SegmentStyle()
        var style = RawSegmentStyle()
        ...
        let scrollview = AttributeSegmentView(frame: CGRect(x: 0, y: 0, width: titlesArr.count * 50, height: Int(appScreenUrl)), segmentStyle: style, titles: titles)
        //: if LanguageManager.shared.direction == .rightToLeft {
        if CapacityLanguageManager.shared.direction == .rightToLeft {
            //: scrollview.frame.origin.x = MixInReactiveCompatible.getScreenWidth()-scrollview.frame.width
            scrollview.frame.origin.x = MixInReactiveCompatible.statusByPlay() - scrollview.frame.width
        }
        // 点击标题，联动礼物面板
        ...
        scrollview.redBagsLab.isHidden = !TableUpReactiveCompatible.share.showBagsRed
        //: return scrollview
        return scrollview
        //: }()
    }()
    ...
    private lazy var giftNumButton: TalkingItemButton = {
        ...
        btn.setImage(UIImage.barName(name: (appReplyTitleData.replacingOccurrences(of: "layer", with: "on") + "_gift_n" + String(main_toBucketIfMessage))), for: .normal)
        //: btn.imageAlignment = .right
        btn.imageAlignment = .right
        //: btn.spaceBetweenTitleAndImage = 4
        btn.spaceBetweenTitleAndImage = 4
        //: btn.addTarget(self, action: #selector(giftNumBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(equalTotal), for: .touchUpInside)
    ...
    private lazy var sendButton: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.colorTitle(type: .Semibold, fontSize: 15)
        //: btn.backgroundColor = UIColor.appThemeColor()
        btn.backgroundColor = UIColor.readModeAchromaticColour()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.setTitle("Send".localized, for: .normal)
        btn.setTitle((String(appEraseText)).localized, for: .normal)
    ...
    private lazy var giftInputNumInputView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: kStatusName - CGFloat(keyborHeight) - 44, width: appUseMessage, height: 44))
        //: view.backgroundColor = .black
        view.backgroundColor = .black
        //: let backButton = UIButton.init()
        let backButton = UIButton()
        //: let img = UIImage.BundleImageNamed(name: "nav_back_black_nor").withRenderingMode(.alwaysTemplate)
        let img = UIImage.barName(name: (String(show_modelKey.prefix(4)) + "back" + String(show_targetGiftId))).withRenderingMode(.alwaysTemplate)
        ...
        sendButton.mastheadState(color: .readModeAchromaticColour(), forState: .normal)
        //: sendButton.setTitleColor(UIColor.white, for: .normal)
        sendButton.setTitleColor(UIColor.white, for: .normal)
        //: sendButton.setTitle("Send".localized, for: .normal)
        sendButton.setTitle((String(appEraseText)).localized, for: .normal)
        ...
        sendButton.rx.tap.subscribe { [weak self] _ in
            ...
            guard Int(str) ?? 0 >= 1 else {
                ...
                self.alongShow(showMsg: String(bytes: constBarData.reversed(), encoding: .utf8)!.localized)
                //: return
                return
            }
            ...
            guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
                ...
                self.alongShow(showMsg: (String(k_equalStr.prefix(5)) + app_selectedValue.replacingOccurrences(of: "filter", with: "e") + String(mainLightMessage)).localized)
                //: return
                return
            }
            ...
            if self.chatRoomID.count > 0 {
                ...
                guard self.chatRoomgiftSelectedMemberModel != nil else {
                    ...
                    self.alongShow(showMsg: (String(appGiftToName.suffix(6)) + " selec" + String(dataSizeUrl.prefix(5)) + "object").localized)
                    //: return
                    return
                }
                ...
                if self.chatRoomSendActionBlock != nil {
                    ...
                    guard let dataType = ReloadDefaultsSerializable(rawValue: self.giftSelectedModel.lastHotIndexPath.section) else { return }
                    //: let dataArr = self.getGiftData(dataType: dataType)
                    let dataArr = self.following(dataType: dataType)
                    //: if index < dataArr.count {
                    if index < dataArr.count {
                        //: let giftModel: TalkingRoomGiftModel = dataArr[index] as! TalkingRoomGiftModel
                        let giftModel: GroupModelType = dataArr[index] as! GroupModelType
    ...
    private lazy var giftInputNameLabel: UILabel = {
        ...
        lb.textColor = UIColor.readModeAchromaticColour()
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var giftInputNumTF: UITextField = {
        ...
        tf.addTarget(self, action: #selector(isoclinic(_:)), for: .editingChanged)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillBeHidden(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(notification(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWasShown(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(cry(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.text = String(bytes: userPageKey.map{pathJust(content: $0)}, encoding: .utf8)!.localized
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(tillMobile), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var seleteObjectBtn: UIButton = {
        ...
        btn.setTitle((String(showAlongPath)).localized, for: .normal)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        //: btn.layer.cornerRadius = 15
        btn.layer.cornerRadius = 15
        ...
        btn.addTarget(self, action: #selector(seleteBindMove), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var blindBoxExplainBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(nameBy), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var giftEmptyView: UILabel = {
        ...
        lab.text = (String(k_rowValue) + app_makePath.replacingOccurrences(of: "lab", with: "n")).localized
    ...
    private lazy var askforBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.atArray(colors: [UIColor(hex: (user_objectId.replacingOccurrences(of: "point", with: "F")))!.cgColor, UIColor(hex: (String(noti_normalSampleName)))!.cgColor], size: CGSize(width: 68, height: 30)), for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Semibold, fontSize: 15)
        btn.titleLabel?.font = UIFont.colorTitle(type: .Semibold, fontSize: 15)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        ...
        btn.setTitle((String(mainDataStr)).localized, for: .normal)
        //: btn.addTarget(self, action: #selector(askforBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(checkFrom), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension ItemDataSource {
    ...
    @objc func trademark() {
        ...
        UIView.animate(withDuration: 0.3) {
            ...
            self.contentView.frame = CGRect(x: 0, y: kStatusName, width: appUseMessage, height: self.contentHeight)
            //: } completion: { _ in
        } completion: { _ in
    ...
    func rawBeauty() {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            ...
            self.contentView.frame = CGRect(x: 0, y: kStatusName - self.contentHeight, width: appUseMessage, height: self.contentHeight)
            //: }, completion: nil)
        }, completion: nil)
    }
    ...
    @objc private func tillMobile() {
        //: let index = self.giftSelectedModel.lastHotIndexPath.row
        let index = self.giftSelectedModel.lastHotIndexPath.row
        //: guard let dataType = GiftDataType(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        guard let dataType = ReloadDefaultsSerializable(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        //: let dataArr = self.getGiftData(dataType: dataType)
        let dataArr = self.following(dataType: dataType)
    ...
    @objc func seleteBindMove() {
        //: meneView = DropDownMemberMenuView.init(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
        meneView = SizeView(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
    ...
    @objc func nameBy() {
        //: dismissView()
        trademark()
        //: EditPushManager.share.func__pushToWebVC(webViewType: .luckyBlindBox)
        EditPushManager.share.postRequest(webViewType: .luckyBlindBox)
    }
...
extension ItemDataSource {
    ...
    func stateFor(pkgItemsetId: String, num: Int) {
        ...
        DispatchQueue.main.async {
            ...
            TableUpReactiveCompatible.share.oversight(dataType: self.currType, dataArr: bagsDataArr)
            ...
            self.illustrationPop(force: true)
        }
    }
}
...
extension ItemDataSource: VideoViewDelegate {
    ...
    func tagButtonMembers() {
        ...
        if model.nickname == (String(app_allValue.suffix(4)) + "Numbers").localized {
            //: return
            return
        }
        //: var ishave = false
        ...
        for tmodel in recentmenuArray {
            ...
            let temp = tmodel as! SaveMeasurable
    ...
    func increaseStart(title: String) {
        //: let str = "View detailed description >".localized
        let str = (String(appLabData.prefix(5)) + String(show_attentionId)).localized
        //: let str2 = title + "\n" + str
        let str2 = title + "\n" + str
...
extension ItemDataSource: UICollectionViewDelegate, UICollectionViewDataSource {
    //: func getGiftData(dataType: GiftDataType) -> [Any] {
    func following(dataType: ReloadDefaultsSerializable) -> [Any] {
        //: return TalkingChatGiftManager.share.getHotGiftDataSource(dataType: dataType)
        return TableUpReactiveCompatible.share.fromLoadType(dataType: dataType)
    }

    //: func giftSendItems() -> Array<Any> {
    func pathItems() -> [Any] {
        //: return TalkingChatGiftManager.share.getSendingItems()
        return TableUpReactiveCompatible.share.underFinish()
    }
    ...
    func obscure(needReload: Bool, mf_coin: String) {
        ...
        if dataArr.count > 0, index >= 0, index < dataArr.count {
            ...
            giftSelectedModel.isNoChangeGiftNumber = (hotModel.showType == BeanDrawVarArg.myStery.rawValue)
        }
    ...
    @objc fileprivate func isoclinic(_ textField: UITextField) {
        ...
        if str.count == 2 && str.hasPrefix("0") {
            ...
            self.giftInputNumTF.text = (String(appOverFormat))
            //: } else {
        } else {
    ...
    @objc func cry(notification: NSNotification) {
        ...
        giftInputNumInputView.frame = CGRect(x: 0, y: kStatusName - CGFloat(keyborHeight) - 44, width: appUseMessage, height: 44)
    }
...
//            text += "  " + (giftNumArrModel.tag ?? "")
    ...
    func enterNum() {
        ...
        let cell = self.hotGiftCollectionView.cellForItem(at: giftSelectedModel.lastHotIndexPath) as? KeyVideoReactiveCompatible
        //: cell?.updateSelectedNumber(number: giftSelectedModel.hotGiftNum)
        cell?.streetTitle(number: giftSelectedModel.hotGiftNum)
    }
    ...
    func collectionView(_: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        guard let dataType = ReloadDefaultsSerializable(rawValue: section) else { return 0 }
        //: let count = getGiftData(dataType: dataType).count
        let count = following(dataType: dataType).count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let identifier = KeyVideoReactiveCompatible.className()
        //: let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! TalkingPackageGiftCell
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! KeyVideoReactiveCompatible
        // 获取数据
        //: guard let dataType = GiftDataType(rawValue: indexPath.section) else { return cell }
        guard let dataType = ReloadDefaultsSerializable(rawValue: indexPath.section) else { return cell }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = following(dataType: dataType)
        // 刷新cell
        ...
        if indexPath.row < dataArr.count {
            ...
            let giftModel: GroupModelType = dataArr[indexPath.row] as! GroupModelType
            //: cell.refreshCellView(currenmodel: giftModel, giftType: dataType)
            cell.second(currenmodel: giftModel, giftType: dataType)
            //: cell.setChecked(checked: giftSelectedModel.lastHotIndexPath == indexPath)
            cell.sendChecked(checked: giftSelectedModel.lastHotIndexPath == indexPath)
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let dataType = ReloadDefaultsSerializable(rawValue: indexPath.section) else { return }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = following(dataType: dataType)
        ...
        giftSelectedModel.isNoChangeGiftNumber = (giftModel.showType == BeanDrawVarArg.myStery.rawValue)
        //: blindBoxExplainBtn.isHidden = !(giftModel.showType == ChatGiftType.myStery.rawValue)
        blindBoxExplainBtn.isHidden = !(giftModel.showType == BeanDrawVarArg.myStery.rawValue)
        ...
        if giftSelectedModel.lastHotIndexPath == indexPath {
            ...
            if giftModel.showType == BeanDrawVarArg.myStery.rawValue && style == .normal {
                //: didClickSelectedCellRow(index: 0, title: "")
                upWith(index: 0, title: "")
                //: return
                return
            }
            //: var sendIndex = indexOfSendItemForNum(num: giftSelectedModel.hotGiftNum)
            var sendIndex = forBind(num: giftSelectedModel.hotGiftNum)
            //: sendIndex = safeObjectAtIndexWithSendItems(addIndex: sendIndex+1)
            sendIndex = counterperson(addIndex: sendIndex + 1)
            //: didClickSelectedCellRow(index: sendIndex, title: "")
            upWith(index: sendIndex, title: "")
            //: } else {
        } else {
            //: giftSelectedModel.hotGiftName = giftModel.name
            giftSelectedModel.hotGiftName = giftModel.name
            ...
            if giftSelectedModel.lastHotCell != nil {
                ...
                let cell: KeyVideoReactiveCompatible = giftSelectedModel.lastHotCell as! KeyVideoReactiveCompatible
                //: cell.setChecked(checked: false)
                cell.sendChecked(checked: false)
            }
            //: let currentCell: TalkingPackageGiftCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! TalkingPackageGiftCell
            let currentCell: KeyVideoReactiveCompatible = self.hotGiftCollectionView.cellForItem(at: indexPath) as! KeyVideoReactiveCompatible
            //: currentCell.setChecked(checked: true)
            currentCell.sendChecked(checked: true)
        ...
        if scrollView == hotGiftCollectionView {
            ...
            if isShowRight {
                ...
                DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.3) {
                    ...
                    self.titleScrollView.encephalon(0, animated: true)
                    //: DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                        //: let dataArr = self.getGiftData(dataType: self.currType)
                        let dataArr = self.following(dataType: self.currType)
    ...
    func illustrationPop(force: Bool = false) {
        // 计算page
        //: var traillingOffsetX = hotGiftCollectionView.contentOffset.x + ScreenWidth
        var traillingOffsetX = hotGiftCollectionView.contentOffset.x + appUseMessage
        //: traillingOffsetX = traillingOffsetX < ScreenWidth ? ScreenWidth : traillingOffsetX
        traillingOffsetX = traillingOffsetX < appUseMessage ? appUseMessage : traillingOffsetX
        //: var page = Int(traillingOffsetX/ScreenWidth-1)
        var page = Int(traillingOffsetX / appUseMessage - 1)
        //: page = page < 0 ? 0:page
        page = page < 0 ? 0 : page
        //: let addition = Int(traillingOffsetX)%Int(ScreenWidth) > 0 ? 1:0
        let addition = Int(traillingOffsetX) % Int(appUseMessage) > 0 ? 1 : 0
        //: page += addition
        page += addition

        // 判断当前选中分区
        //: var giftType = GiftDataType.Hot
        var giftType = ReloadDefaultsSerializable.Hot
        ...
        if force == true || currType != giftType {
            ...
            pageControl.numberOfPages = TableUpReactiveCompatible.share.per(perPageCount: 8, dataType: currType)
            // 切换title
            //: titleScrollView.currentIndex = currType.rawValue
            titleScrollView.currentIndex = currType.rawValue
            //: titleScrollView.adjustUIWhenBtnOnClickWithAnimate(true)
            titleScrollView.noCell(true)
            //: askforBtn.isHidden = !(currType == GiftDataType.Hot && self.style == .normal && StatisticalTableReactiveCompatible.share.loginUserMode.sex == Gender.female.rawValue)
            askforBtn.isHidden = !(currType == ReloadDefaultsSerializable.Hot && self.style == .normal && StatisticalTableReactiveCompatible.share.loginUserMode.sex == FalloutCompatibleValue.female.rawValue)
            // 盲盒礼物说明 显示/隐藏
            ...
            if giftSelectedModel.lastShowType == BeanDrawVarArg.myStery.rawValue && giftSelectedModel.lastHotIndexPath.section == currType.rawValue {
                //: setsetBlindBoxExplainData(title: giftSelectedModel.lastDescription ?? "")
                increaseStart(title: giftSelectedModel.lastDescription ?? "")
                //: } else {
            } else {
    ...
    private func notBig() {
        ...
        self.giftSelectedModel = BlockHandyJSON()
...
extension ItemDataSource: InstalmentViewDelegate {
    ...
    func upWith(index: Int, title _: String) {
        ...
        if numberOfGift > 0 {
            ...
            popView?.authorSNameStart(view: giftInputNumInputView)
            //: popView?.showInView(view: self.window!)
            popView?.socioEconomicClassOrientation(view: self.window!)
    ...
    func beginIndex(index: Int) -> Int {
        ...
        if sendingItems.count > 0 && index < sendingItems.count {
            ...
            let giftNumArrModel: MakeTransformable = sendingItems[index] as! MakeTransformable
    ...
    func forBind(num: Int) -> Int {
        //: var index = 0
        var index = 0
        //: for i in 0..<giftSendItems().count {
        for i in 0 ..< pathItems().count {
            //: let model: TalkingGiftNumArrModel = giftSendItems()[i] as! TalkingGiftNumArrModel
            let model: MakeTransformable = pathItems()[i] as! MakeTransformable
            //: if model.num == num {
            if model.num == num {
                //: break
                break
    ...
    func counterperson(addIndex: Int) -> Int {
        //: if addIndex > giftSendItems().count-1 {
        if addIndex > pathItems().count - 1 {
            //: return 0
            return 0
        }
        //: return addIndex
...
extension ItemDataSource {
    ...
    private func load() {
        ...
        let tagView = UIView(frame: CGRect(x: 0, y: 0, width: appUseMessage, height: kStatusName - contentHeight))
        //: tagView.backgroundColor = .clear
        tagView.backgroundColor = .clear
        //: self.addSubview(tagView)
        self.addSubview(tagView)
        //: tagView.addGestureRecognizer(UITapGestureRecognizer.init(target: self, action: #selector(dismissView)))
        tagView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(trademark)))
        ...
        scrollContentView.snp.makeConstraints { make in
            ...
            make.height.equalTo(show_tableValue)
            //: make.width.equalTo(ScreenWidth)
            make.width.equalTo(appUseMessage)
        }
        ...
        hotGiftCollectionView.snp.makeConstraints { make in
            ...
            make.width.equalTo(appUseMessage - 10)
        }
        ...
        pageControl.snp.makeConstraints { make in
            ...
            make.height.equalTo(data_changeDeviceFormat)
        ...
        bottomView.snp.makeConstraints { make in
            ...
            make.height.equalTo(noti_showKeyBarName)
        }
    ...
    private func noneUser() {
        //: StatisticalTableReactiveCompatible.share.loginUserMode.rx
        StatisticalTableReactiveCompatible.share.loginUserMode.rx
            //: .observeWeakly(String.self, "mf_coin")
            .observeWeakly(String.self, (user_countPath.replacingOccurrences(of: "size", with: "f") + String(kMarginTableKey.suffix(5))))
            ...
            .subscribe(onNext: { [weak self] value in
                ...
                if value != nil {
                    ...
                    self.obscure(needReload: false, mf_coin: value!)
                }
                //: })
            })
            //: .disposed(by: disposeBag)
        ...
        TableUpReactiveCompatible.share.rx
            //: .observeWeakly(Bool.self, "showBagsRed")
            .observeWeakly(Bool.self, (String(mainBlindPath) + String(main_pairTitle)))
            //: .subscribe(onNext: { [weak self] (value) in
            .subscribe(onNext: { [weak self] value in
                //: guard let self = self else { return }
                guard let self = self else { return }
                ...
                TableUpReactiveCompatible.share.viewAcross(type: self.style, isRefresh: true, completion: {
                    //: self.updateGiftInfo(needReload: true, mf_coin: StatisticalTableReactiveCompatible.share.loginUserMode.mf_coin)
                    self.obscure(needReload: true, mf_coin: StatisticalTableReactiveCompatible.share.loginUserMode.mf_coin)
                    //: })
                })
                //: })
            })
