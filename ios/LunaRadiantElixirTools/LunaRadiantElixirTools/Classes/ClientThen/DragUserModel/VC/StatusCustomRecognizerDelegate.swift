...
/*: "#777777" :*/
fileprivate let data_modelTitle:[Character] = ["#","7","7","7","7","7","7"]

/*: "#333333" :*/
fileprivate let dataFeeActionTrueMessage:String = "#333333"

/*: "Search" :*/
fileprivate let mainTransformName:[Character] = ["S","e","a","r","c","h"]

/*: "Details" :*/
fileprivate let main_promptTitle:String = "Detailsmake else"

/*: "nav_back_black_nor" :*/
fileprivate let app_colorVideoUrl:String = "temp touch sex firstnav_b"
fileprivate let user_statusExtraTitle:String = "ack_norvar equal object"
...
// __CLOSE_PRINT__
//
//  StatusCustomRecognizerDelegate.swift
//  AbroadTalking
//
...
class StatusCustomRecognizerDelegate: DropBaseViewController {
    ...
    private lazy var categoryView: JXSegmentedView = {
        ...
        segmentedDataSource.titleNormalColor = UIColor(hex: (String(data_modelTitle)))!
        //: segmentedDataSource.titleSelectedColor = UIColor.init(hex: "#333333")!
        segmentedDataSource.titleSelectedColor = UIColor(hex: (dataFeeActionTrueMessage.capitalized))!
        ...
        indicator.indicatorColor = UIColor(hex: (dataFeeActionTrueMessage.capitalized))!
...
//        view.defaultSelectedIndex = currentIndex
    ...
    private lazy var titleArray: [String] = //: return ["Search".localized, "Details".localized]
        [(String(mainTransformName)).localized, (String(main_promptTitle.prefix(7))).localized]
    //: }()

    //: private lazy var dataVC: [TalkingBaseViewController] = {
    private lazy var dataVC: [DropBaseViewController] = //: return [PopNameViewController(), ToViewController()]
        [PopNameViewController(), ToViewController()]
    //: }()
    ...
    private lazy var backButton: UIButton = {
        ...
        let img = UIImage.barName(name: (String(app_colorVideoUrl.suffix(5)) + "ack_bl" + String(user_statusExtraTitle.prefix(7)))).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .black
        btn.tintColor = .black
        //: btn.addTarget(self, action: #selector(backButtonClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(viewStartClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension StatusCustomRecognizerDelegate: JXSegmentedViewDelegate {
...
extension StatusCustomRecognizerDelegate: JXPagingViewDelegate {
...
extension StatusCustomRecognizerDelegate {
    /// 返回按钮事件
    //: @objc private func backButtonClick() {
    @objc private func viewStartClick() {
