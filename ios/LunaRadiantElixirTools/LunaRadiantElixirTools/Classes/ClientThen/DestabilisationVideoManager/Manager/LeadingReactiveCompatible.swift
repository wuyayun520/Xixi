...
extension LeadingReactiveCompatible {
    ...
    func deal(_ frontCamera: Bool) {
        ...
        self.rowFront(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func sizeThan(_ openCamera: Bool) {
    ...
    func cellView() {
        ...
        DispatchQueue.main.async {
            ...
            self.subSash(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension LeadingReactiveCompatible {
    ...
    private func rowFront(front: Bool) {
...
extension LeadingReactiveCompatible {
    ...
    func adept() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(notBack(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(showDelete(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(playing(notif:)),
    ...
    @objc private func notBack(notif: Notification?) {
        //: if notif == nil { 
    ...
    @objc private func showDelete(notif: Notification) {
    ...
    @objc func playing(notif: Notification) {
