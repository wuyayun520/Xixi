...
/*: "&sr=6" :*/
fileprivate let showResignEditId:[Character] = ["&","s","r","=","6"]
...
enum FileMirrorPath: String, CaseIterable {
...
class VideoManager: NSObject {
    ...
    class func towardView(urlType: StemBasicType) -> String {
        //: var url = StatisticalTableReactiveCompatible.share.appConfigMode.urlH5Domain
        var url = StatisticalTableReactiveCompatible.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(StatisticalTableReactiveCompatible.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : StatisticalTableReactiveCompatible.share.appUserConfigMode.fullRechargePage)
            url.append(StatisticalTableReactiveCompatible.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : StatisticalTableReactiveCompatible.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(StatisticalTableReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : StatisticalTableReactiveCompatible.share.appUserConfigMode.halfRechargePage)
            url.append(StatisticalTableReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : StatisticalTableReactiveCompatible.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = StatisticalTableReactiveCompatible.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = StatisticalTableReactiveCompatible.share.appUserConfigMode.halfRechargePage.appending((String(showResignEditId)))
            //: url.append(StatisticalTableReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(StatisticalTableReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
