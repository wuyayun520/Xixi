...
fileprivate let main_countKey:[UInt8] = [0xec,0xeb,0xec,0xf1,0xad,0xe6,0xea,0xe1,0xe0,0xf7,0xbf,0xac,0xa5,0xed,0xe4,0xf6,0xa5,0xeb,0xea,0xf1,0xa5,0xe7,0xe0,0xe0,0xeb,0xa5,0xec,0xe8,0xf5,0xe9,0xe0,0xe8,0xe0,0xeb,0xf1,0xe0,0xe1]
...
class DateReactiveCompatible: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_countKey.map{$0^133}, encoding: .utf8)!)
    }
    ...
    private lazy var progressView: ItemProgressView = {
        ...
        let v = ItemProgressView(frame: self.frame, progressBgColor: self.progressBgColor, progressPlayedColor: self.progressPlayedColor, progressCachedColor: self.progressCachedColor)
    ...
    private lazy var panGesture: UIPanGestureRecognizer = {
        ...
        let v = UIPanGestureRecognizer(target: self, action: #selector(selected(gesture:)))
        //: return v
        return v
        //: }()
    }()
    ...
    private lazy var tapGesture: UIPanGestureRecognizer = {
        ...
        let v = UIPanGestureRecognizer(target: self, action: #selector(demand(gesture:)))
        //: return v
        return v
        //: }()
    }()
...
extension DateReactiveCompatible {
    //: @objc func panGesture(gesture: UIPanGestureRecognizer) {
    @objc func selected(gesture: UIPanGestureRecognizer) {
        // 移动的距离
    ...
    @objc func demand(gesture: UIPanGestureRecognizer) {
