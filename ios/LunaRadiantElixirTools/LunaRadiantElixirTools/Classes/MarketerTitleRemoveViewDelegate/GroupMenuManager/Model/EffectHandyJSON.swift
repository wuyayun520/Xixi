...
let show_failVoiceData = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let show_detailId = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let user_explainUrl = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct EffectHandyJSON: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
