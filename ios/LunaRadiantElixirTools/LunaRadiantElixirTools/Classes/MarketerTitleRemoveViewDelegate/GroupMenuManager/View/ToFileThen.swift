...
fileprivate let constRowMessage:[UInt8] = [0x86,0x81,0x86,0x9b,0xc7,0x8c,0x80,0x8b,0x8a,0x9d,0xd5,0xc6,0xcf,0x87,0x8e,0x9c,0xcf,0x81,0x80,0x9b,0xcf,0x8d,0x8a,0x8a,0x81,0xcf,0x86,0x82,0x9f,0x83,0x8a,0x82,0x8a,0x81,0x9b,0x8a,0x8b]

/*: "icon_mini_voice_end" :*/
fileprivate let user_nameStr:[Character] = ["i","c","o","n","_","m","i","n"]
fileprivate let kRecordId:[Character] = ["i","_","v","o","i","c","e","_","e","n","d"]

/*: "#F95151" :*/
fileprivate let constSendKey:[Character] = ["#","F","9","5","1","5","1"]

/*: "End of call" :*/
fileprivate let noti_textPath:[Character] = ["E","n","d"," ","o","f"," ","c","a","l","l"]

/*: "img_home_shadow_icon" :*/
fileprivate let data_fromValue:[Character] = ["i","m","g","_","h","o","m","e","_","s","h"]
fileprivate let mainHiddenName:String = "load"
fileprivate let k_reportMessageName:String = "dow_iconresult down add pic"
...
class ToFileThen: PathThen {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constRowMessage.map{$0^239}, encoding: .utf8)!)
    }
    ...
    lazy var renderView: UIView = { // 视频渲染视图
        ...
        view.backgroundColor = .blindConstraint()
        //: view.layer.cornerRadius = 8
        view.layer.cornerRadius = 8
        //: view.layer.masksToBounds = true
        view.layer.masksToBounds = true
    ...
    private lazy var statusIcon: UIImageView = {
        ...
        img.image = UIImage.barName(name: (String(user_nameStr) + String(kRecordId)))
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(constSendKey)))
        ...
        lab.text = (String(noti_textPath)).localized
    ...
    private lazy var shadowImg: UIImageView = {
        ...
        img.image = UIImage.barName(name: (String(data_fromValue) + mainHiddenName.replacingOccurrences(of: "load", with: "a") + String(k_reportMessageName.prefix(8))))
...
extension ToFileThen {
    ...
    func constraintOf(point: String) {
