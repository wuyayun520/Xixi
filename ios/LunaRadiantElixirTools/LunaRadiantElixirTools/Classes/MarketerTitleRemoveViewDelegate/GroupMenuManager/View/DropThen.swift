...
fileprivate let const_editFormat:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class DropThen: UIView {
    ...
    private var giftSendItem = [MakeTransformable()]
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: const_editFormat.reversed(), encoding: .utf8)!)
    }
    ...
    func thanBy(attributedText: NSAttributedString) {
        ...
        shadow.shadowColor = UIColor.doTitle()
    ...
    func alongSumerval(frame: CGRect) {
        //: self.frame = frame
        self.frame = frame
    ...
    private lazy var gradientLayer: CAGradientLayer = {
        ...
        lay.colors = [UIColor.buttonThemeTip(255, 232, 72, 1).cgColor, // 浅黄
                      //: UIColor.RGBA(253, 170, 52, 1).cgColor
                      UIColor.buttonThemeTip(253, 170, 52, 1).cgColor, // 深黄
        ]
