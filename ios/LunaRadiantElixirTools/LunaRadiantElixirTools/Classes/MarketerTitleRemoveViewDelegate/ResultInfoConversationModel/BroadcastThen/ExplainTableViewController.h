 ...
 *
 *  ControllerFile 协议和 ExplainTableViewController 类。
 *  ExplainTableViewController 是聊天界面的核心类，负责聊天界面大部分核心业务逻辑的处理与运算。
 *  该类的详细属性与功能，请参展本文件中 ExplainTableViewController 的具体声明。
 *
 ******************************************************************************/
...
@class ExplainTableViewController;
//: @class BroadcastThen;
@class BroadcastThen;
//: @class ReloadViewCellData;
@class ReloadViewCellData;
//: @class V2TIMMessage;
@class V2TIMMessage;
...
@protocol ControllerFile <NSObject>
...
- (void)tabled:(ExplainTableViewController *)controller;
...
- (void)messages:(ExplainTableViewController *)controller;
...
- (BOOL)scale:(ExplainTableViewController *)controller atVideoHandle:(UIView *)view;
 ...
 */
//: - (ReloadViewCellData *)messageController:(TUIMessageController *)controller onNewMessage:(V2TIMMessage *)data;
- (ReloadViewCellData *)accountingData:(ExplainTableViewController *)controller shrug:(V2TIMMessage *)data;
 ...
 */
//: - (BroadcastThen *)messageController:(TUIMessageController *)controller onShowMessageData:(ReloadViewCellData *)data;
- (BroadcastThen *)alongFor:(ExplainTableViewController *)controller pause:(ReloadViewCellData *)data;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageAvatar:(BroadcastThen *)cell;
- (void)message:(ExplainTableViewController *)controller alongAcross:(BroadcastThen *)cell;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageContent:(BroadcastThen *)cell;
- (void)singleOut:(ExplainTableViewController *)controller contrastInfo:(BroadcastThen *)cell;
 ...
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageMenu:(NSInteger)menuType withData:(ReloadViewCellData *)data;
- (void)direction:(ExplainTableViewController *)controller important:(NSInteger)menuType frame:(ReloadViewCellData *)data;
/**
...
/*重发*/
//: - (void)messageController:(TUIMessageController *)controller onRetryMessageContent:(BroadcastThen *)cell;
- (void)effect:(ExplainTableViewController *)controller user:(BroadcastThen *)cell;

/*引用*/
//: - (void)messageController:(TUIMessageController *)controller onReplyMessage:(ReloadViewCellData *)cellData;
- (void)shareOrientationOn:(ExplainTableViewController *)controller menu:(ReloadViewCellData *)cellData;

/*点击引用*/

//: - (void)messageController:(TUIMessageController *)controller onClickReplyMessage:(ReloadViewCellData *)cellData;
- (void)indicator:(ExplainTableViewController *)controller name:(ReloadViewCellData *)cellData;
...
/////////////////////////////////////////////////////////////////////////////////
//
//                         ExplainTableViewController
//
/////////////////////////////////////////////////////////////////////////////////

/**
 * 腾讯云 TUIKit
 *  【模块名称】ExplainTableViewController
...
@interface ExplainTableViewController : UITableViewController

/**
 *  执行 ControllerFile 协议的委托
 */
//: @property (nonatomic, weak) id<TMessageControllerDelegate> delegate;
@property (nonatomic, weak) id<ControllerFile> delegate;
 ...
 * @param uiMsgs 待删除的数据
 */
//- (void)deleteMessages:(NSArray<ReloadViewCellData *> *)uiMsgs;
...
/**
 * 批量将V2TIMessage转换成ReloadViewCellData
 */
