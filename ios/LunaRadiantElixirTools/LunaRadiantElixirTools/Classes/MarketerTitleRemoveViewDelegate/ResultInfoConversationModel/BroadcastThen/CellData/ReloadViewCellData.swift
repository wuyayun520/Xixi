...
@objc public enum EquationPopCustomReflectable: UInt {
...
@objc public enum LeadingVarArg: UInt {
...
// MARK: - ReloadViewCellData

/**
 * 【模块名称】ReloadViewCellData
 ...
 */
//: @objcMembers public class ReloadViewCellData: TCommonCellData {
@objcMembers public class ReloadViewCellData: NameUpReactiveCompatible {
    ...
    public var direction: LeadingVarArg = .MsgDirectionIncoming
    ...
    public var translateStatus: EquationPopCustomReflectable = .MsgTranslate_init
    ...
    public var msgModel: OverModel = OverModel()
    ...
    public var cellLayout: EffectEditThen!
    ...
    public init(direction: LeadingVarArg) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.sizeTake()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = EffectEditThen(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = EffectEditThen(isIncomming: false)
    ...
    public override func fullPhaseOfTheMoon(_ width: CGFloat) -> CGFloat {
