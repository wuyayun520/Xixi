...
fileprivate let k_conversationText:[UInt8] = [0xa1,0xa6,0xa1,0xbc,0xe0,0xab,0xa7,0xac,0xad,0xba,0xf2,0xe1,0xe8,0xa0,0xa9,0xbb,0xe8,0xa6,0xa7,0xbc,0xe8,0xaa,0xad,0xad,0xa6,0xe8,0xa1,0xa5,0xb8,0xa4,0xad,0xa5,0xad,0xa6,0xbc,0xad,0xac]
...
class ClientShieldView: UIView {
    //: class func create(_ frame: CGRect) -> UIView {
    class func videoActionSave(_ frame: CGRect) -> UIView {
        //: return MAScreenShieldView(frame: frame)
        return ClientShieldView(frame: frame)
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_conversationText.map{$0^200}, encoding: .utf8)!)
    }
