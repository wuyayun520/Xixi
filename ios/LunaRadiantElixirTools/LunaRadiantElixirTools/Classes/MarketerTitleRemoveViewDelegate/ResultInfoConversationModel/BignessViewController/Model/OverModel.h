...
@property (nonatomic, strong)ExamineedModel *quoteMsgInfo;

//: @property (nonatomic, strong)ViewThen *userInfoModel;
@property (nonatomic, strong)ViewThen *userInfoModel;
...
@property (nonatomic, strong) StorageResponseModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) ByModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) ToMainModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) Model *wantGift; /// 想要礼物
...
@interface StorageResponseModel : JSONModel
...
+ (void)withId:(StorageResponseModel *)photoModel toId:(NSString *)msgID;

//: + (NSMutableDictionary<NSString *, NSString *> *)loadLocalIntimatePhotoDict;
+ (NSMutableDictionary<NSString *, NSString *> *)orientation;
...
+ (void)onEye:(ByModel *)videoModel deliverForUnwantedData:(NSString *)msgID;

//: + (NSMutableDictionary<NSString *, NSString *> *)loadLocalIntimateVideoDict;
+ (NSMutableDictionary<NSString *, NSString *> *)doing;
...
@interface ToMainModel: JSONModel
...
@interface StrengthModel : JSONModel
...
@interface ComputerSimulationModel : JSONModel
...
@interface EqualModel : JSONModel
...
+ (void)shrink:(NSString *)msgID;

//: + (NSMutableArray *)loadAskForGiftArr;
+ (NSMutableArray *)textModel;

//: @end
@end

//: @interface AbTalkingChatMsgQuoteModel : JSONModel
@interface ExamineedModel : JSONModel
...
@property (nonatomic, strong) StorageSizeModel *renderData;

//: - (BOOL)isQuoteMsg;
- (BOOL)add;

//: - (CGSize)quoteSize:(NSInteger)maxWidth;
- (CGSize)theDataSize:(NSInteger)maxWidth;
...
@interface StorageSizeModel : JSONModel
