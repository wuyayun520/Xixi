...
@objcMembers class DataHandyJSON: NSObject, HandyJSON {
    //: var msgInfo: TalkingMsgInfoModel?
    var msgInfo: RateInputThen?
    //: var gift: TalkingMsgGiftModel?
    var gift: ProvideReactiveCompatible?
    //: var user: TalkingMsgUserModel?
    var user: TalkingReactiveCompatible?
    //: var toUser: TalkingMsgToUserModel?
    var toUser: NowReactiveCompatible?
...
class RateInputThen: NSObject, HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var content = ""
    var content = ""
...
class TalkingReactiveCompatible: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class NowReactiveCompatible: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class ProvideReactiveCompatible: NSObject, HandyJSON {
    //: var iosEffect = ""
    var iosEffect = ""
    //: var animationTimes = ""
    var animationTimes = ""
