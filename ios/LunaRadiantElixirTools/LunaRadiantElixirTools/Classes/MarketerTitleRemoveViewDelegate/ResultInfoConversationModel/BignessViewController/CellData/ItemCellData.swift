...
/*: _" :*/
fileprivate let mainMessageMakePath:String = "equal"

/*: ".png" :*/
fileprivate let noti_infoUrl:String = ".pngmessage in"
...
//: @objcMembers public class ItemCellData: TalkingChatMsgBaseCellData {
@objcMembers public class ItemCellData: AggregationThen {
    ...
    override public var msgModel: OverModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.totalimateWrite(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func atEnable(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(notiClickText)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + StatisticalTableReactiveCompatible.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + StatisticalTableReactiveCompatible.share.loginUserMode.userID + (String(noti_infoUrl.prefix(4)))
        ...
        let imageData = UIImage.file(image, cover: 2 * 1024)
