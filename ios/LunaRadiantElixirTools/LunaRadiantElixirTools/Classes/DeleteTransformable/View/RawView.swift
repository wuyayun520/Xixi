...
fileprivate let show_fileData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Pending review" :*/
fileprivate let user_recordMsg:String = "Pendiinput for lab"
fileprivate let const_bottomData:String = "eviecell"
...
class RawView: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_fileData.reversed(), encoding: .utf8)!)
    }
...
extension RawView {
    ...
    func muffCreate(model: ScreenHandyJSON, row: Int, isLast: Bool) {
        //: index = row
        index = row
        //: islast = isLast
        islast = isLast
        ...
        if model.status == 0 {
            ...
            statusLb.text = (String(user_recordMsg.prefix(5)) + "ng r" + const_bottomData.replacingOccurrences(of: "cell", with: "w")).localized
