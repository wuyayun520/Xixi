...
fileprivate let show_timeFormat:[UInt8] = [0x2f,0x28,0x2f,0x32,0x6e,0x25,0x29,0x22,0x23,0x34,0x7c,0x6f,0x66,0x2e,0x27,0x35,0x66,0x28,0x29,0x32,0x66,0x24,0x23,0x23,0x28,0x66,0x2f,0x2b,0x36,0x2a,0x23,0x2b,0x23,0x28,0x32,0x23,0x22]

/*: "Add" :*/
fileprivate let main_capacityMsg:[Character] = ["A","d","d"]

/*: "btn_me_edit" :*/
fileprivate let k_contentData:[Character] = ["b","t","n","_","m","e","_","e","d","i","t"]

/*: "Program" :*/
fileprivate let appOffId:String = "to false main self dataProgram"
...
class NameReactiveCompatible: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        self.backgroundColor = .messageText()
        //: selectionStyle = .none
        selectionStyle = .none
        //: setupSubviews()
        keep()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_timeFormat.map{$0^70}, encoding: .utf8)!)
    }
    ...
    private lazy var backBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(referencePoint), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var tipsLab: UILabel = {
        ...
        lb.text = (String(main_capacityMsg)).localized
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var editImg: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.barName(name: (String(k_contentData))))
        //: imag.isUserInteractionEnabled = false
        imag.isUserInteractionEnabled = false
        //: return imag
        return imag
...
extension NameReactiveCompatible {
    ...
    func receiveManager(title: String, icon: String) {
        //: iconImg.image = UIImage.BundleImageNamed(name: icon)
        iconImg.image = UIImage.barName(name: icon)
        //: titleLab.text = title.localized
        titleLab.text = title.localized
        //: if title == "Program" {
        if title == (String(appOffId.suffix(7))) {
    ...
    func pauseWithPopular(isHidden: Bool) {
    ...
    func askWait() {
        ...
        backBtn.occurrenceOf(width: appUseMessage - 30, height: 50, corners: [.topLeft, .topRight], cornerRadii: .init(width: 8, height: 8))
    }
}
