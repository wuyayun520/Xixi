...
fileprivate let show_addText:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "btn_me_edit" :*/
fileprivate let kHiddenFormat:String = "let image to add chapterbtn_me"
fileprivate let app_arrayNeverMsg:[Character] = ["_","e","d","i","t"]
...
class CapacityViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_addText.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.barName(name: (String(kHiddenFormat.suffix(6)) + String(app_arrayNeverMsg))))
...
extension CapacityViewCell {
    //: func setCellMessage(titile: String, row: Int, isLast: Bool) {
    func loadAt(titile: String, row: Int, isLast: Bool) {
    ...
    func playerAdd() {
        ...
        titleBLB.font = UIFont.colorTitle(type: .Medium, fontSize: 15)
        //: detailLB.font = UIFont.pingfangFont(type: .Medium, fontSize: 15)
        detailLB.font = UIFont.colorTitle(type: .Medium, fontSize: 15)
        //: editImag.isHidden = false
        editImag.isHidden = false
    ...
    func failurePermission(detail: String) {
        //: index = 0
        index = 0
        //: islast = true
        islast = true
