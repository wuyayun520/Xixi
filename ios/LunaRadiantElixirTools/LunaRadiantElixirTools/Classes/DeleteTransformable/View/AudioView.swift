...
fileprivate let app_loadKey:[UInt8] = [0x51,0x56,0x51,0x4c,0x10,0x5b,0x57,0x5c,0x5d,0x4a,0x2,0x11,0x18,0x50,0x59,0x4b,0x18,0x56,0x57,0x4c,0x18,0x5a,0x5d,0x5d,0x56,0x18,0x51,0x55,0x48,0x54,0x5d,0x55,0x5d,0x56,0x4c,0x5d,0x5c]

/*: "icon_me_voice_white" :*/
fileprivate let notiTotalNameTitleMsg:String = "frame color selficon_m"
fileprivate let data_alongName:[Character] = ["e"]
fileprivate let app_tapContent:String = "error user value total point_voic"

/*: "btn_auto_write" :*/
fileprivate let dataViewTitle:[Character] = ["b","t","n","_","a","u","t","o","_","w","r","i","t","e"]

/*: "Pending review" :*/
fileprivate let showEqualMsg:String = "make array labPend"
fileprivate let main_nameUrl:String = "ing make hair"

/*: "%d″" :*/
fileprivate let constLiveMessage:String = "%d\u{2033}"

/*: "get json error" :*/
fileprivate let const_viewModeMessage:String = "to color guard add imageget "
fileprivate let user_editPath:[Character] = ["r","r","o","r"]
...
class AudioView: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_loadKey.map{$0^56}, encoding: .utf8)!)
    }
    ...
    lazy var statusLb: UILabel = {
        ...
        lb.textColor = UIColor.makeMessage()
        //: return lb
        return lb
        //: }()
    }()
    ...
    lazy var audioBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.atArray(colors: UIColor.govern(), size: CGSize(width: 155, height: 35)), for: .normal)
    ...
    lazy var playIconView: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.barName(name: (String(notiTotalNameTitleMsg.suffix(6)) + String(data_alongName) + String(app_tapContent.suffix(5)) + "e_white")))
        //: return imag
        return imag
        //: }()
    }()
    ...
    lazy var editBtn: UIButton = {
        ...
        btn.setImage(UIImage.barName(name: (String(dataViewTitle))), for: .normal)
...
extension AudioView {
    ...
    func bindLast(model: ScreenHandyJSON, row: Int, isLast: Bool) {
        //: index = row
        index = row
        //: islast = isLast
        islast = isLast
        ...
        if model.status == 0 {
            ...
            statusLb.text = (String(showEqualMsg.suffix(4)) + String(main_nameUrl.prefix(4)) + "review").localized
    ...
    func imageActivity(isPlaying: Bool) {
    ...
    func audioInEffect() {
        ...
        do {
            ...
            let url = RequestThen.default.littleness(type: .Play_Audio_Wave)
            ...
            printLog(message: (String(const_viewModeMessage.suffix(4)) + "json e" + String(user_editPath)))
        }
    }
}
