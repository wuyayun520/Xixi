...
// __CLOSE_PRINT__
//
//  CommingleReactiveCompatible.swift
//  AbroadTalking
//
...
protocol ExitLayoutDelegate: NSObjectProtocol {
...
class CommingleReactiveCompatible: UICollectionViewFlowLayout {
    //: var delegate: TalkingTagCollectionFlowLayoutDelegate?
    var delegate: ExitLayoutDelegate?
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        for i in 1..<attributes.count {
            ...
            if i == attributes.count-1 {
                ...
                self.delegate?.via(layoutH: curAttr.frame.maxY)
            }
        }
