...
/*: "id" :*/
fileprivate let app_liveSendName:[Character] = ["i","d"]
...
struct PathUserTransformable: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: TypeMeasurable?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [SkinnyTalkingAudienceStochasticProcessUserMeasurable]? // 相册
    ...
    var aiExtraInfo = InputHandyJSON() // AI模型
    //: var vipSkinId = 0
...
struct SkinnyTalkingAudienceStochasticProcessUserMeasurable: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func appearance(compareTo: SkinnyTalkingAudienceStochasticProcessUserMeasurable) -> Bool {
        //: return
        return
...
struct InputHandyJSON: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
