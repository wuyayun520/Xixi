...
/*: "Game Center" :*/
fileprivate let user_fileFemaleFatalStr:[Character] = ["G","a","m","e"," ","C","e","n","t","e"]
fileprivate let constToolStrengthData:String = "host"

/*: "You've got no list yet." :*/
fileprivate let noti_topFormat:String = "You\'ve"
fileprivate let user_taskTipAsTitle:String = "touch"
fileprivate let user_monthPath:String = "got make case path style"
fileprivate let notiSucceedKey:String = "t yet.data string image m count"

/*: "list" :*/
fileprivate let kErrorKey:String = "liconstraint"
...
class SquareBlockFlowLayout: DropBaseViewController {
    //: override func viewDidLoad() {
    override func viewDidLoad() {
        //: super.viewDidLoad()
        super.viewDidLoad()
        //: self.title = "Game Center".localized
        self.title = (String(user_fileFemaleFatalStr) + constToolStrengthData.replacingOccurrences(of: "host", with: "r")).localized
        //: setupSubviews()
        giftView()
    ...
    private lazy var emptyView: EmptyView = {
        ...
        style.TipsTitle = (noti_topFormat + user_taskTipAsTitle.replacingOccurrences(of: "touch", with: " ") + String(user_monthPath.prefix(4)) + "no lis" + String(notiSucceedKey.prefix(6))).localized
...
extension SquareBlockFlowLayout {
    /// 获取游戏列表
    ...
    private func atLoad() {
        ...
        ControlThen.listPhone(category: 1) { [weak self] _, result, _ in
            //: ProgressHUD.dismiss()
            ...
            json[(kErrorKey.replacingOccurrences(of: "constraint", with: "st"))].arrayObject?.forEach { dict in
...
extension SquareBlockFlowLayout: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.shade(model: dataArr[indexPath.row], nameColor: .blindConstraint())
        //: return cell
        return cell
    }
