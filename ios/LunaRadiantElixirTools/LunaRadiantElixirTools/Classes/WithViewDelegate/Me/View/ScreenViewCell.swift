...
fileprivate let noti_piFormat:[UInt8] = [0x11,0x16,0x11,0x1c,0xd0,0xb,0x17,0xc,0xd,0x1a,0xe2,0xd1,0xc8,0x10,0x9,0x1b,0xc8,0x16,0x17,0x1c,0xc8,0xa,0xd,0xd,0x16,0xc8,0x11,0x15,0x18,0x14,0xd,0x15,0xd,0x16,0x1c,0xd,0xc]

fileprivate func indexClick(style num: UInt8) -> UInt8 {
...
/*: "btn_me_edit" :*/
fileprivate let notiToName:String = "btn_mecolor object height"
fileprivate let show_viewCellMessage:[Character] = ["_","e","d","i","t"]

/*: "icon_me_lw" :*/
fileprivate let show_makeData:String = "ICON"

/*: " Reward" :*/
fileprivate let constDateName:[Character] = [" ","R","e","w","a","r","d"]

/*: "FF506D" :*/
fileprivate let constModelContent:[Character] = ["F","F","5","0","6","D"]
...
class ScreenViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_piFormat.map{indexClick(style: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.barName(name: (String(notiToName.prefix(6)) + String(show_viewCellMessage))))
        //: return imag
        return imag
        //: }()
    }()
    ...
    private lazy var taskCenterBtn: UIButton = {
        ...
        btn.setImage(UIImage.barName(name: (show_makeData.lowercased() + "_me_lw")), for: .normal)
        //: btn.setTitle(" Reward".localized, for: .normal)
        btn.setTitle((String(constDateName)).localized, for: .normal)
        //: btn.setTitleColor(UIColor.init(hex: "FF506D"), for: .normal)
        btn.setTitleColor(UIColor(hex: (String(constModelContent))), for: .normal)
...
extension ScreenViewCell {
    ...
    private func toPath() {
        ...
        backView.frame = CGRect(x: 15, y: 0, width: appUseMessage - 30, height: backView_h)
        ...
        if index == 0, islast {
            ...
            backView.occurrenceOf(width: backView.frame.size.width,
