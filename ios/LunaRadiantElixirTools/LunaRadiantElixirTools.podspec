...
Pod::Spec.new do |s|
  s.name         = "LunaRadiantElixirTools"
  s.version      = "1.0.0"
  s.summary      = "iOS LunaRadiantElixirTools Module."
  s.author       = { "LunaRadiantElixirTools" => "LunaRadiantElixirTools.me" }
  s.homepage     = "LunaRadiantElixirTools"
  s.source       = { :git => "http://LunaRadiantElixirTools.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'LunaRadiantElixirTools/Classes/**/*'
  s.resources = "LunaRadiantElixirTools/Resources/*.bundle"
  s.vendored_libraries = 'LunaRadiantElixirTools/Classes/**/*.a'
